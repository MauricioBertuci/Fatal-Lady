...
st.title("📊 Dashboard Administrativo - Fatal Lady (Plotly)")


# ler a connection string do env
DATABASE_URL = os.getenv("DATABASE_URL")
if not DATABASE_URL:
    st.error("Variável de ambiente DATABASE_URL não encontrada. Defina antes de rodar.")
    st.stop()
